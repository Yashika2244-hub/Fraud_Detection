...
#Fraud Analysis (credit_score category wise)
create view Credit_score as 
     SELECT  sum(t.amount) as total_amount,count(t.id) as count,
    CASE
        WHEN u.credit_score >= 750 THEN 'Excellent'
        WHEN u.credit_score >= 650 THEN 'Good'
        WHEN u.credit_score >= 550 THEN 'Fair'
        ELSE 'Poor'
